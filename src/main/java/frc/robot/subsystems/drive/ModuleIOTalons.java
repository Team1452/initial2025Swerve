 ...
 */
public class ModuleIOTalons implements ModuleIO {
  ...
  public ModuleIOTalons(
    ...
    turnConfig.ExternalFeedback.ExternalFeedbackSensorSource =
        switch (constants.FeedbackSource) {
          case RemoteCANcoder -> ExternalFeedbackSensorSourceValue.RemoteCANcoder;
          case FusedCANcoder -> ExternalFeedbackSensorSourceValue.FusedCANcoder;
          case SyncCANcoder -> ExternalFeedbackSensorSourceValue.SyncCANcoder;
    ...
    turnConfig.Commutation.BrushedMotorWiring = BrushedMotorWiringValue.Leads_A_and_B;
