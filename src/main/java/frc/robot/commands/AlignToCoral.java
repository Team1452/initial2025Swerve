...
public class AlignToCoral extends Command {
  ...
  @Override
  public void execute() {
    // Retrieve the latest target observation from vision for the specified camera.
    // It is assumed that the coral target is provided by a vision camera (e.g. a VisionIOTargetOnly
    // device).
